    ...
    <div className="App">
      <nav className="flex w-auto px-5 h-20 bg-green-500 relative flex items-center justify-between">
          ...
          <div>
              ...
              <div className="mx-5 absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
